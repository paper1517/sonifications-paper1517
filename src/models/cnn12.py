"""
Standard 1D-Convolutional encoder
"""
...
class Encoder(nn.Module):
    def __init__(self, fc1_dim=1000,
        ...
        self.features = nn.Sequential(
            OrderedDict([
                ("conv1", nn.Conv1d(1, int(64 * self.filter_coeff),
                ...
                ("conv2", nn.Conv1d(int(self.filter_coeff * 64), int(self.filter_coeff * 64),
                ...
                ("conv3", nn.Conv1d(int(self.filter_coeff * 64), int(self.filter_coeff * 128),
                ...
                ("conv4", nn.Conv1d(int(self.filter_coeff * 128), int(self.filter_coeff * 128),
                ...
                ("conv5", nn.Conv1d(int(self.filter_coeff * 128), int(self.filter_coeff * 256),
                ...
                ("conv6", nn.Conv1d(int(self.filter_coeff * 256), int(self.filter_coeff * 256),
                ...
                ("conv7", nn.Conv1d(int(self.filter_coeff * 256), int(self.filter_coeff * 512),
                ...
                ("conv8", nn.Conv1d(int(self.filter_coeff * 512), int(self.filter_coeff * 512),
                ...
                ("conv9", nn.Conv1d(int(self.filter_coeff * 512), int(self.filter_coeff * 1024),
                ...
                ("conv10", nn.Conv1d(int(self.filter_coeff * 1024), int(self.filter_coeff * 1024),
                ...
                ("conv11", nn.Conv1d(int(self.filter_coeff * 1024), int(self.filter_coeff * 2048),
